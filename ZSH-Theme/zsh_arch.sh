...
# Install base dependencies using pacman
sudo pacman -S --needed --noconfirm zsh curl git unzip xclip fzf base-devel
...
# Install additional font and icon support packages
